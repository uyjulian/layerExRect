...
#define TVPRemoveConstOpacity TVPRemoveConstOpacity_c
#define TVPConstColorAlphaBlend TVPConstColorAlphaBlend_c
#define TVPConstColorAlphaBlend_d TVPConstColorAlphaBlend_d_c
#define TVPConstColorAlphaBlend_a TVPConstColorAlphaBlend_a_c
#define TVPFillColor TVPFillColor_c
#define TVPFillMask TVPFillMask_c
#define TVPFillARGB TVPFillARGB_c
#define TVPCopyMask TVPCopyMask_c
...
TVP_GL_FUNC_PTR_EXTERN_DECL(void, TVPFillColor_c, (tjs_uint32 *dest, tjs_int len, tjs_uint32 color));
TVP_GL_FUNC_PTR_EXTERN_DECL(void, TVPFillMask_c, (tjs_uint32 *dest, tjs_int len, tjs_uint32 mask));
TVP_GL_FUNC_PTR_EXTERN_DECL(void, TVPFillARGB_c, (tjs_uint32 *dest, tjs_int len, tjs_uint32 value));
TVP_GL_FUNC_PTR_EXTERN_DECL(void, TVPCopyMask_c, (tjs_uint32 *dest, const tjs_uint32 *src, tjs_int len));
